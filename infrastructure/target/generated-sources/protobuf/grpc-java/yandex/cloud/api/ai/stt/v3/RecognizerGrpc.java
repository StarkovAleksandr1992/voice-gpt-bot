...
@javax.annotation.Generated(
    ...
    comments = "Source: speechkit/stt/v3/stt_service.proto")
...
public final class RecognizerGrpc {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<yandex.cloud.api.ai.stt.v3.Stt.StreamingRequest> recognizeStreaming(
  ...
  /**
   * Base class for the server implementation of the service Recognizer.
   * <pre>
   * A set of methods for voice recognition.
   * </pre>
   */
  public static abstract class RecognizerImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return RecognizerGrpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service Recognizer.
   * <pre>
   * A set of methods for voice recognition.
   * </pre>
   */
  public static final class RecognizerStub
      extends io.grpc.stub.AbstractAsyncStub<RecognizerStub> {
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service Recognizer.
   * <pre>
   * A set of methods for voice recognition.
   * </pre>
   */
  public static final class RecognizerBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<RecognizerBlockingStub> {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service Recognizer.
   * <pre>
   * A set of methods for voice recognition.
   * </pre>
   */
  public static final class RecognizerFutureStub
      extends io.grpc.stub.AbstractFutureStub<RecognizerFutureStub> {
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              ...
              yandex.cloud.api.ai.stt.v3.Stt.StreamingResponse>(
                service, METHODID_RECOGNIZE_STREAMING)))
        .build();
  }
